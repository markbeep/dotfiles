# Do 25 Sep 2025 19:07:00 CEST - Base packages

AddPackage --foreign maliit-keyboard   # Virtual keyboard based on Maliit framework
AddPackage --foreign splix             # CUPS drivers for SPL (Samsung Printer Language) printers
...
AddPackage endeavouros-branding        # Default EndeavourOS background images and icons
...
AddPackage kde-cli-tools               # Tools based on KDE Frameworks to better interact with the system
...
AddPackage python-reportlab            # A proven industry-strength PDF generating solution
...
CreateLink /etc/localtime /usr/share/zoneinfo/Europe/Zurich
...
CopyFile /etc/pacman.d/endeavouros-mirrorlist.bak
CopyFile /etc/pacman.d/mirrorlist
CopyFile /etc/pacman.d/mirrorlist.bak
...
CopyFile /etc/dracut.conf.d/resume.conf
